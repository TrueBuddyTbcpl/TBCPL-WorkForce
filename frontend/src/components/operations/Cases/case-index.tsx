...
const CaseIndex = ({ isAdminView = false }: Props) => {
  ...
  const basePath = isAdminView ? '/admin/cases' : '/operations/cases';
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                ...
                {isAdminView ? 'All Cases (Admin View)' : 'Case Management'}
              </h1>
        ...
        {/* Filters */}
        <div className="bg-white rounded-lg shadow-sm border p-4 mb-6 flex flex-wrap items-center gap-4">
